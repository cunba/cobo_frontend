...
import { COLORS_DARK, COLORS_LIGHT, PALLET } from './config/Colors';
import { ROUTES, isiOS, lightMode } from './config/Constants';
		...
		<>
			{!loading ?
				...
				<View style={{ width: '100%', height: '100%' }}>
					<View style={{ flex: 4, flexDirection: 'row', alignItems: "center", justifyContent: "center", backgroundColor: COLORS.background, paddingTop: 50 }}>
